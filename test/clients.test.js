...
describe('Clients', function () {
    ...
    // @TODO : fix all this tests
    /*
    it('test valid WHOIS', function (done) {
    ...
    it('invalid WHO (bug #9)', function (done) {
        var createClient = this.server.createClient.bind(this.server);
    ...
    it('socket error handling (bug #10)', function (done) {
        var createClient = this.server.createClient.bind(this.server)
    ...
    it("users shouldn't be able to join channel twice (bug #12)", function (done) {
        var createClient = this.server.createClient.bind(this.server)
            , server = this.server.server;
    ...
    it('invalid ban mask (bug #19)', function (done) {
        var createClient = this.server.createClient.bind(this.server);
    ...
    it('invalid away status (bug #18)', function (done) {
        var createClient = this.server.createClient.bind(this.server);
    ...
    it('send messages with colons (#49)', function (done) {
        var createClient = this.server.createClient.bind(this.server)
            , server = this.server.server
    ...
    it('invalid nicks (#27)', function (done) {
        var nick = 'a|ex'
            , self = this
