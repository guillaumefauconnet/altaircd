...
const protocol = require(path.join(__dirname, '..', 'lib', 'protocol'));
const invalidNick = protocol.validations.invalidNick;
const invalidChannel = protocol.validations.invalidChannel;
const invalidChannelKey = protocol.validations.invalidChannelKey;

describe('Protocol', function () {
    it('test nickname validation', function (done) {
        // Valid nicknames
    ...
    it('test channelname validation', function (done) {
        // Valid channelnames
    ...
    it('test channelkey validation', function (done) {
        // Valid channelkeys
